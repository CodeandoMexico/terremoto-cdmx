...
| [Acopio API](https://acopio-api.skycatch.net/v1/acopios) | API para conectarse a base de datos de centros de acopio | [https://github.com/azubieta/hgathering-api](https://github.com/azubieta/hgathering-api) | `#sismomx-acopio-api` | Javascript, Hapi | 
