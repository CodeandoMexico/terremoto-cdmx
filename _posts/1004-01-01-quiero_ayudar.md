...
<div class="row">
  ...
  <div class="section-line" />
    <p>
      <a target="_blank" class="button button-primary" href="https://docs.google.com/spreadsheets/d/1ijleBcHJH_3V2nbMeXTjH4hTDYsjcdodYvHqhTc8C8c/edit#gid=0">
...
**[Website (#sismomx-website)](http://sismomexico.org/){:target="_blank"}**

**[API de centros de acopios (@javierbyte @chubas @rbdr)](https://github.com/Skycatch/acopio-api){:target="_blank"}**

**[App de priorización de necesidad para vincular con centros de acopio](https://github.com/civica-digital/quake-relief-cdmx){:target="_blank"}**

**[App de SMS (@denialtorres @perezpriego)](https://sismomx-sms.herokuapp.com){:target="_blank"}**

**[Obtención de información a partir de Twitter (@Edgar_Arroyo)](https://github.com/Garyi/Filtro-Informaci-n-Valiosa-Terremoto-Twitter){:target="_blank"}**

**[Script de python para encontrar a personas desaparecidas (@hans)](https://github.com/regenhans/earthquake-bot){:target="_blank"}**
